          ...
          <div class="row mt-sm mb-lg">
            ...
            <div class="col-md-3">
              ...
              <ul class="sidesubmenu">
                ...
                <li class="active"><a href="article.php">บทความ</a></li>
            ...
            <div class="col-md-9">
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <h4 class="text_head--h4 mb-sm"> <i class="fa fa-star"> </i> บทความแนะนำ</h4>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="#">โครงการศุภาลัย</a></td>
                          <td><a href="#">โครงการศุภาลัย มีการปรับราคาบ้านเดี่ยวและทาวน์โฮมในตัวเมืองหลายแห่ง ทั้งนี้เพื่อตอบรับกระแสของความต้องการที่มีมากขึ้น</a></td>
                          <td>02/09/60</td>
                          <td><a href="#">ธุรกิจ</a></td>
                        </tr>
                        <!-- end news, 1 item-->
