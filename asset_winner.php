          ...
          <div class="row mb-lg mt-xs">
            <div class="col-md-3">
              <ul class="sidesubmenu">
                <li><a href="asset_favourites.php">Favourites</a></li>
                <li><a href="asset_bidding.php">Bidding</a></li>
                <li class="active"><a href="asset_winner.php">Winner</a></li>
              </ul>
            </div>
            <div class="col-md-9">
              <div class="row mb-sm">
                <div class="col-xs-12">
                  <h4 class="text_head--h4">Asset Winner</h4>
                </div>
              </div>
              <div class="row">
                <div class="col-xs-12">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">20 Aug 2017 - 22 Aug 2017</td>
                          <td class="text-center"><span class="label label-default text-sm">Already</span>
                          </td>
                        </tr>
                        <tr>
                          <td><a class="asset_img" href="#"><img src="assets/img/img-test.jpg"><span> <i class="fa fa-sign-in"> </i>  ดูรายละเอียด</span></a></td>
