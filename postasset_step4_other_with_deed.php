          ...
          <div class="row">
            <div class="col-md-12">
              <form class="form-horizontal container-fluid form-label-left">
                ...
                <!-- ราคาประเมินของทรัพย์-->
                <div class="row mb-sm">
                  <div class="col-xs-12">
                    <h4 class="text_head--h4">ราคาประเมินของทรัพย์</h4>
                  </div>
                </div>
                <div class="row mb-sm">
                  <div class="col-sm-12"><a href="#"> <i class="fa fa-external-link"> </i> คำนวณราคาประเมิน คลิกที่นี่</a></div>
                </div>
                <div class="row mb-sm">
                  <label class="control-label col-sm-12 col-sm-wauto">โฉนดเลขที่</label>
                  <div class="col-sm-2">
                    <input class="form-control" type="text">
                  </div>
                  <label class="control-label col-sm-12 col-sm-wauto">ราคาประเมิน</label>
                  <div class="col-sm-3">
                    <input class="form-control" type="text">
                  </div>
                </div>
                ...
                <div class="row mb-sm">
                  <div class="form-group col-xs-12">
                    <label class="control-label col-sm-12 col-sm-wauto">ราคาประเมินรวม</label>
                    <div class="col-sm-3 col-xs-10">
                      <input class="form-control" type="text">
                    </div>
                    <p class="form-control-static col-sm-2 col-xs-2">บาท</p>
                  </div>
                </div>
                ...
                <div class="row mb-sm">
                  <div class="col-xs-12">
                    <h4 class="text_head--h4">ค่าใช้จ่ายในการโอน</h4>
                  </div>
                </div>
                <div class="row">
                  <div class="form-group col-xs-12">
                    <label class="control-label col-sm-2 col-sm-wauto">ประมาณการค่าใช้จ่ายในการโอน </label>
                    <div class="col-sm-3 col-xs-10">
                      <input class="form-control" type="text">
                    </div>
                    <p class="form-control-static col-sm-2 col-xs-2">บาท</p>
                ...
                <div class="row">
                  <div class="form-group col-xs-12">
                    <label class="control-label col-sm-3">ค่าธรรมเนียมการโอน </label>
                    <div class="col-sm-2">
                      <div class="radio">
                        <label>
                          <input type="radio">ผู้ซื้อ
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="row">
                  <div class="form-group col-xs-12">
                    <label class="control-label col-sm-3">ค่าภาษีธุรกิจเฉพาะ </label>
                    <div class="col-sm-2">
                      <div class="radio">
                        <label>
                          <input type="radio">ผู้ซื้อ
                    ...
                    <div class="form-control-static col-sm-1 col-xs-1"><a class="fa fa-question-circle" href="#"></a></div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="form-group col-xs-12">
                    <label class="control-label col-sm-3">ค่าอากรแสตมป์ </label>
                    <div class="col-sm-2">
                      <div class="radio">
                        <label>
                          <input type="radio">ผู้ซื้อ
                ...
                <div class="row">
                  <div class="form-group col-xs-12">
                    <label class="control-label col-sm-3">ค่าภาษีหัก ณ ที่จ่าย </label>
                    <div class="col-sm-2">
                      <div class="radio">
                        <label>
                          <input type="radio">ผู้ซื้อ
