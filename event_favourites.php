          ...
          <div class="row mb-lg mt-xs">
            <div class="col-md-3">
              <ul class="sidesubmenu">
                <li><a href="event_dashboard.php">Event</a></li>
                <li class="active"><a href="event_favourites.php">Favourites</a></li>
              </ul>
            </div>
            <div class="col-md-9">
              <div class="row mb-sm">
                <div class="col-xs-12">
                  <h4 class="text_head--h4">Event Favourites</h4>
                </div>
              </div>
              <div class="row">
                <div class="col-xs-12">
                  <div class="table-responsive pos-relative asset-user">
                    <table class="table table-striped table-hover table-bordered">
                      ...
                      <thead>
                        <tr>
                          <th class="text-center">Event Into</th>
                          <th>&nbsp;</th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            <p class="text_desc">Type : Tour</p>
                            <h4 class="text_head--h4"> <a href="#">Auction Info</a></h4>
                            <p class="text_desc">
                              Start Date: 20 Aug 2017<br>
                              End Date: 22 Aug 2017<br>
                              Ticket Price: 1,000 บาท <br>
                            </p>
                          </td>
